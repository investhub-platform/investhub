...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative w-full min-h-screen overflow-hidden bg-[#020617] text-white selection:bg-blue-500/30 pt-24 pb-20">
      ...
      {/* --- MASSIVE TOP-DOWN CIRCULAR GLOW --- */}
      <svg 
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 mt-12 flex flex-col items-center text-center">
        ...
        >
          <span className="text-white font-semibold">Startup investing made simple.</span> <br className="hidden sm:block"/>
          AI screens the idea. Experts check the code. You fund the progress safely.
        </motion.p>
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center h-full">
              <div className="flex-1 text-left">
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 text-blue-400 text-xs font-bold uppercase tracking-wider mb-4 border border-blue-500/20">
                  <BrainCircuit className="w-4 h-4" /> AI Screening
                </div>
                <h3 className="text-2xl font-bold text-white mb-2">Instant Risk Scores</h3>
                <p className="text-slate-400 text-sm leading-relaxed">
                  Our AI reads the pitch decks and checks the market to give you a simple success score before you spend a dime.
                </p>
              </div>
          ...
          <div className="col-span-1 p-6 md:p-8 rounded-3xl bg-[#0B0D10]/80 backdrop-blur-xl border border-white/10 relative overflow-hidden group hover:border-emerald-500/30 transition-colors flex flex-col justify-between bento-card">
            ...
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-500/10 text-emerald-400 text-xs font-bold uppercase tracking-wider mb-4 border border-emerald-500/20">
                <Wallet className="w-4 h-4" /> Safe Funding
              </div>
              <h3 className="text-lg font-bold text-white mb-2">Pay as they build</h3>
            </div>
            
            <div className="mt-6 p-4 rounded-xl bg-white/5 border border-white/5 backdrop-blur-sm">
              <div className="text-xs text-slate-400 mb-1">Funds Locked (Step 2)</div>
          ...
          <div className="col-span-1 md:col-span-3 p-6 rounded-3xl bg-[#0B0D10]/80 backdrop-blur-xl border border-white/10 flex flex-col sm:flex-row items-center justify-between gap-6 group hover:border-purple-500/30 transition-colors bento-card">
            ...
            <div className="flex items-center gap-3">
              <div className="flex -space-x-3">
                <div className="w-10 h-10 rounded-full bg-slate-800 border-2 border-[#0B0D10] flex items-center justify-center overflow-hidden"><img src="https://i.pravatar.cc/100?img=11" alt="Expert" /></div>
                <div className="w-10 h-10 rounded-full bg-slate-800 border-2 border-[#0B0D10] flex items-center justify-center overflow-hidden"><img src="https://i.pravatar.cc/100?img=33" alt="Expert" /></div>
                <div className="w-10 h-10 rounded-full bg-slate-800 border-2 border-[#0B0D10] flex items-center justify-center overflow-hidden"><img src="https://i.pravatar.cc/100?img=12" alt="Expert" /></div>
              </div>
              <div className="flex items-center gap-1 text-xs font-semibold text-purple-400 bg-purple-500/10 px-3 py-1.5 rounded-full border border-purple-500/20">
                <CheckCircle2 className="w-3.5 h-3.5" /> 14 Active Checks
              </div>
            </div>
          </div>
